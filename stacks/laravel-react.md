# Laravel + React (Inertia + Breeze) Stack

## Overview
Full-stack Laravel with React frontend using Inertia.js for SPA-like experience.
...
# Start Vite for React hot reload (Terminal 2)
npm run dev
```
